...
# Plot both datasets from the same file 'tree.dat'
plot 'tree.dat' using 1:2 with points linestyle 1 title 'add', \
     'tree.dat' using 1:3 with points linestyle 2 title 'lookup'